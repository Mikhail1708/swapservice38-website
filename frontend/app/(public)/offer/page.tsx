...
export const metadata: Metadata = {
  title: 'Договор оферты — SWAP SERVICE 38',
  description: 'Публичный договор оферты интернет-магазина SWAP SERVICE 38. Условия заказа, оплаты, доставки и возврата товаров.',
  openGraph: {
    title: 'Договор оферты — SWAP SERVICE 38',
    description: 'Публичный договор оферты интернет-магазина SWAP SERVICE 38.',
    url: 'https://swapservice38.ru/offer',
    siteName: 'SWAP SERVICE 38',
    locale: 'ru_RU',
    type: 'website',
  },
  alternates: {
    canonical: 'https://swapservice38.ru/offer',
  },
};
