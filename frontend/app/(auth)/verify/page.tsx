    ...
    <div className="min-h-screen flex items-center justify-center bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-bold text-black mt-6 mb-2">Подтверждение email</h1>
        ...
        {success ? (
          <div className="text-center py-8">
            ...
            <h2 className="text-xl font-medium text-black">Email подтверждён!</h2>
            <p className="text-gray-400 text-sm mt-2">Перенаправление на вход...</p>
          </div>
        ) : (
          <>
            {error && (
