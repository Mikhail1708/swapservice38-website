...
const STATS = [
  ...
  { value: '300+', label: 'установленных двигателей' },
];
      ...
      <div className="container-custom grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
        <div className="max-w-lg">
          ...
          <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
            <p>
             SWAP SERVICE 38 — это команда энтузиастов, которая живёт автомобилями и техническим совершенством. 
             Мы не просто обслуживаем или улучшаем машины — мы создаём для них новую жизнь, 
             вкладывая в каждую деталь инженерную страсть и многолетний опыт. 
             От сложных свапов до собственных разработок, 
             от ремонта до производства — мы делаем автомобили надёжнее, 
             мощнее и готовыми к любым дорогам.
            </p>
          </div>
          <Link
            href="/swaps"
