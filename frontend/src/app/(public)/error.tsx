    ...
    <div className="min-h-screen flex items-center justify-center bg-background pt-32">
      <div className="text-center max-w-md px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-6 justify-center">
          <button
            onClick={reset}
            className="px-6 py-2.5 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition inline-flex items-center gap-2"
          >
