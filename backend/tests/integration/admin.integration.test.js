...
describe('Admin API Integration', () => {
    ...
    beforeAll(async () => {
        ...
        adminId = admin.id;
        adminToken = require('jsonwebtoken').sign({ id: admin.id, email: admin.email, role: 'admin' }, process.env.JWT_SECRET || 'test_secret');
        // Создаём менеджера
        ...
        managerToken = require('jsonwebtoken').sign({ id: manager.id, email: manager.email, role: 'manager' }, process.env.JWT_SECRET || 'test_secret');
    });
    afterAll(async () => {
