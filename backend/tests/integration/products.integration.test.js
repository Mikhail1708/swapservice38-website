...
describe('Products Integration', () => {
    ...
    describe('GET /api/products', () => {
        ...
        it('should filter products by category', async () => {
            ...
            expect(response.status).toBe(200);
            expect(mockAxios.get).toHaveBeenCalledWith(expect.stringContaining('/api/public/products'), expect.objectContaining({
...
//# sourceMappingURL=products.integration.test.js.map