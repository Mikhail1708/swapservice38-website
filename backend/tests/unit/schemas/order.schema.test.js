...
describe('Order Schemas', () => {
    ...
    describe('orderItemSchema', () => {
        ...
        it('should validate valid order item', () => {
            const result = order_schema_1.orderItemSchema.safeParse(validItem);
            expect(result.success).toBe(true);
        });
        it('should validate with string productId', () => {
            const data = { ...validItem, productId: '123' };
            const result = order_schema_1.orderItemSchema.safeParse(data);
            expect(result.success).toBe(true);
            if (result.success) {
    ...
    describe('clientSchema', () => {
        ...
        it('should validate valid client data', () => {
            const result = order_schema_1.clientSchema.safeParse(validClient);
            expect(result.success).toBe(true);
        });
        it('should validate without optional fields', () => {
            ...
            const result = order_schema_1.clientSchema.safeParse(data);
            expect(result.success).toBe(true);
        });
    ...
    describe('createOrderSchema', () => {
        ...
        it('should validate valid order', () => {
            const result = order_schema_1.createOrderSchema.safeParse(validOrder);
            expect(result.success).toBe(true);
        });
        it('should validate without optional fields', () => {
            const data = {
            ...
            const result = order_schema_1.createOrderSchema.safeParse(data);
            expect(result.success).toBe(true);
        });
    ...
    describe('updateOrderSchema', () => {
        ...
        it('should validate valid update', () => {
            const result = order_schema_1.updateOrderSchema.safeParse(validUpdate);
            expect(result.success).toBe(true);
        });
        it('should validate partial update', () => {
            const data = { guestName: 'Иван Петров' };
            const result = order_schema_1.updateOrderSchema.safeParse(data);
            expect(result.success).toBe(true);
        });
        it('should validate empty update', () => {
            const result = order_schema_1.updateOrderSchema.safeParse({});
            expect(result.success).toBe(true);
        });
        it('should reject invalid phone', () => {
...
//# sourceMappingURL=order.schema.test.js.map