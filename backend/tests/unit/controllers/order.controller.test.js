...
exports.deleteOrderController = exports.getUserOrdersController = exports.getOrderController = exports.createOrderController = void 0;
    ...
    try {
        ...
        if (userCart) {
            ...
            for (const guestItem of guestItems) {
                const existingIndex = mergedItems.findIndex((item) => String(item.productId) === String(guestItem.productId));
                if (existingIndex !== -1) {
...
const createOrderController = async (req, res) => {
    try {
        ...
        const guestId = req.query.guestId || req.cookies?.guestId;
        if (!userId) {
        ...
        const { deliveryMethod, deliveryAddress, comment, client, } = req.body;
        if (!client) {
...
//# sourceMappingURL=order.controller.test.js.map